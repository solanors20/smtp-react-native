...
public class Mail extends javax.mail.Authenticator {
  ...
  public Mail() {
    ...
    _senderAlias = ""; // Show alias in the email for the sender
  ...
  public boolean send() throws Exception {
    ...
    if (!_user.equals("") && !_pass.equals("") && _to.length > 0
      ...
      if (!_from.equals(_senderAlias)) {
        msg.setFrom(new InternetAddress(_from, _senderAlias));
      } else {
      ...
      Log.i("TEST", "Transport start.");
      // send email
      Transport.send(msg);
      Log.i("TEST", "Transport finished.");
      return true;
    } else {
      return false;
    }
  ...
  public String get_senderAlias() {
    return _senderAlias;
  }

  public void set_senderAlias(String _senderAlias) {
    this._senderAlias = _senderAlias;
  }
