...
SMTP for react native. Only works on Android.

## Installation

```sh
npm install smtp-react-native
```
...
```js
import { sendEmail } from 'smtp-react-native';
...
const result = await sendEmail({
    ...
    password: "your pass",
    recipients: "recpient@mail.com", // Coma separated
    subject: "New subject",
    htmlBody: "Email body",
    attachmentsInBase64: [
